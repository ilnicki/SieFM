        ...
        implements CommandListener
{
     ...
     */
    public Id3EditorForm(String filename, Displayable parent) throws IOException
    {
    ...
    /**
     * Получить строку теговой информации из mp3-файла (разделена на части
     * символом \n).
     *
     * @param filename
     * @return
