...
public class Zipper implements Runnable
{
    ...
    /**
     * Добавляет файл/папку file к открытому ZipOutputStream-у zos во внутренний
     * путь path.
     *
     * @param zos
     * @param file
            ...
            String path, ProgressCallback callback) throws IOException, ZipException
    {
        ...
        if (file.charAt(file.length() - 1) == '/')
            ...
            zip_a_file(zos, file, path, callback);
    }

    /**
     * Добавляет файл file к открытому ZipOutputStream-у zos во внутренний путь
     * path.
     *
     * @param zos
     * @param file
    ...
    /**
     * Добавляет папку dir к открытому ZipOutputStream-у zos во внутренний путь
     * path.
     *
     * @param zos
     * @param callback
