 ...
 * @author Dmytro
 */
public class TextViewCanvas extends KeyCodeCanvas implements CommandListener
{
    ...
    /**
     * Просто открыть входной поток, без дополнительных процедур закрытия и без
     * возможности записи.
     *
     * @param is
     * @param enc
    ...
    /**
     * Открыть входной поток с использованием дополнительных процедур закрытия
     * потока (например, закрытие соответствующего FileConnection).
     *
     * @param is
     * @param enc
     * @param cls
    ...
    /**
     * Открыть входной поток с использованием дополнительных процедур закрытия
     * потока (например, закрытие соответствующего FileConnection) и с
     * возможностью записи через oso.
     *
     * @param is
     * @param enc
     * @param cls
    ...
    /**
     * Осознать, в какой кодировке is, записать кодировку в enc, позиционировать
     * is на начало текста и вернуть это смещение.
     *
     * @param is
     * @return
