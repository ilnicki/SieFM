...
public class Filesystem
{
    ...
    public static final int TYPE_TMO = 6;
    ...
    public Filesystem() throws IOException
    {
        try
        {
            Class cl = Class.forName("com.siemens.mp.io.File");
            sFile = true;
    ...
    /**
     * Распаковать в dir файлы из текущего ZIP-архива, перечисленные в vs (с
     * сохранением относительных путей). Если vs == null => распаковать всё.
     *
     * @param vs
     * @param dir
     * @param progress
    ...
    /**
     * Получить список файлов из ZIP-файла zipfile, находящихся внутри него в
     * папке zipdir.
     */
    ...
    /**
     * Вернуть начало имени файла ВНУТРИ zip-архива (начинается после
     * .../archive.zip/).
     *
     * @param filename
     * @return
    ...
    /**
     * Получить список файлов и папок в данной папке Работа с ZIP-архивами
     * прозрачная.
     *
    ...
    public static boolean renameFile(String oldName, String newName)
    {
        ...
        } catch (Exception e)
        {
            if (sFile)
            {
                ...
                {
                    return com.siemens.mp.io.File.rename(oldName, Main.currentPath + newName) >= 0;
                } catch (Exception e1)
                {
                    return false;
                }
    ...
    public static boolean makeNewDirNotRec(String fn)
    {
        try
        {
            FileConnection conn = (FileConnection) Connector.open("file:///" + fn, Connector.READ_WRITE);
            conn.mkdir();
            conn.close();
        } catch (Exception e)
        {
    ...
    /**
     * Создать новый файл, записать туда text в UTF-8 и опционально BOM UTF-8
     * сигнатуру.
     *
     * @param fn
     * @param text
