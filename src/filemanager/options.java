    ...
    public static void saveOptions()
    {
        if (optionsStore != null)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < KeyConfigCanvas.keyConfig.length; i++)
                    dos.writeInt(KeyConfigCanvas.keyConfig[i]);
                dos.flush();
            ...
            } catch (InvalidRecordIDException ridex)
            {
                ...
                try
                {
                    optionsStore.addRecord(options, 0, options.length);
    ...
    public static void restoreOptions()
    {
        ...
        if (optionsStore != null)
        {
            try
            {
                ...
                volume = dis.readByte();
                if (volume < 0)
                    volume = -volume; // громкость аудио плейера
                ...
                for (int i = 0; i < KeyConfigCanvas.keyConfig.length; i++)
                    KeyConfigCanvas.keyConfig[i] = dis.readInt();
                dis.close();
            } catch (Exception ex)
            {
            }
